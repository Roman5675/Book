...
for (let i = 0; i < allMusic.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <audio class="${allMusic[i].src}" src="${allMusic7[i].way}"></audio>
              </li>`;
...
for (let i = 0; i < allMusicSecond.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <span id="${allMusicSecond[i].src}" class="audio-duration">3:40</span>
...
for (let i = 0; i < allMusicThird.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <span id="${allMusicThird[i].src}" class="audio-duration">3:40</span>
...
for (let i = 0; i < allMusicFourth.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <span id="${allMusicFourth[i].src}" class="audio-duration">3:40</span>
...
for (let i = 0; i < allMusicFifth.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <span id="${allMusicFifth[i].src}" class="audio-duration">3:40</span>
...
for (let i = 0; i < allMusicSixth.length; i++) {
  ...
  let liTag = `<li li-index="${i + 1}">
                ...
                <span id="${allMusicSixth[i].src}" class="audio-duration">3:40</span>
